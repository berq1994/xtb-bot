...
def send_telegram_http(text: str, timeout_sec: int = 15):
    token = os.getenv("TELEGRAM_BOT_TOKEN") or os.getenv("TELEGRAMTOKEN") or os.getenv("TG_BOT_TOKEN")
    chat_id = os.getenv("TELEGRAM_CHAT_ID") or os.getenv("CHATID") or os.getenv("TG_CHAT_ID")
