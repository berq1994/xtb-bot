...
def run_corporate_research():
    headline = "Firma zveĹ™ejnila vĂ˝znamnĂ© firemnĂ­ oznĂˇmenĂ­ a novĂ˝ vĂ˝hled"
    ...
    item = build_intelligence_item(
        "corporate",
        headline,
        "OficiĂˇlnĂ­ firemnĂ­ zprĂˇva mĹŻĹľe zmÄ›nit krĂˇtkodobĂ˝ sentiment a intradennĂ­ bias.",
        entities,
        rel,
        imp,
    )
